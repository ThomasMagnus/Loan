...
/* harmony import */ var _modules_detectInput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/detectInput */ "./src/js/modules/detectInput.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modulePageSlider = new _modules_slider_mainSlider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    page: '.moduleapp',
    btn: '.next',
    prevModuleBtn: '.prevmodule'
  });
  modulePageSlider.render();
  var video = new _modules_video__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup__video .play', '.overlay', '.close');
  video.init();
  new _modules_video__WEBPACK_IMPORTED_MODULE_1__["default"]('.module__video .play', '.overlay', '.close').init();
  ...
  difference.render();
  var form = new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.form');
  form.postData();
  new _modules_detectInput__WEBPACK_IMPORTED_MODULE_5__["default"]('[type="email"]').checkInput();
});

/***/ }),

/***/ "./src/js/modules/detectInput.js":
/*!***************************************!*\
  !*** ./src/js/modules/detectInput.js ***!
  \***************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Inpup; });
...
/*#__PURE__*/
function () {
  function Inpup(email) {
    _classCallCheck(this, Inpup);
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindBtn",
    value: function bindBtn() {
      var _this = this;

      var getProperty = function getProperty(count) {
        _this.cards.forEach(function (item) {
          if (_this.cards[count] == item) item.style.display = 'flex';
        });
      };

      var getCards = function getCards(e) {
        var target = e.target;

        if (target.closest('.officerold')) {
          getProperty(_this.officerOldCount);
          _this.officerOldCount++;
        } else if (target.closest('.officernew')) {
          getProperty(_this.officerNewCount);
          _this.officerNewCount++;
        }
      };

      this.plus.forEach(function (item) {
        return item.addEventListener('click', getCards);
      });
    }
  }, {
    key: "render",
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function createMask() {
      var input = document.querySelectorAll('[name="phone"]');
    ...
    value: function postData() {
      ...
      var createStatus = function createStatus(statusText) {
      ...
      try {
        this.form.addEventListener('submit', function (e) {
          ...
          fetch('./assets/question.php', {
            ...
            return createStatus(status.error);
          }).finally(function () {
...
function (_Slider) {
  ...
  function MainSlider(btn, page, prevModuleBtn) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btn, page, prevModuleBtn));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlider() {
      ...
      try {
        this.prevModuleBtn.forEach(function (item) {
          item.addEventListener('click', function (e) {
            e.preventDefault();
            _this2.slideIndex--;

            _this2.showSlide(_this2.slideIndex - 1);
          });
        });
...
function (_Slider) {
  ...
  function MiniSlider(page, nextBtn, prevBtn, slides, animated, interval) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, page, nextBtn, prevBtn, slides, animated, interval));
  }

  _createClass(MiniSlider, [{
    key: "bindStyle",
    value: function bindStyle() {
      var _this = this;
      ...
      try {
        this.slides.forEach(function (item) {
          ...
          item.classList.remove(_this.animated);
        });
    ...
    value: function bindBtn() {
      ...
      var nextBtn = function nextBtn() {
        if (_this2.detectArg()) {
          _this2.page.insertBefore(_this2.slides[0], _this2.prevBtn);
        } else {
      ...
      if (this.interval == true) {
        var intervalSlide = setInterval(nextBtn, 5000);
      }
      ...
      try {
        ...
        this.prevBtn.addEventListener('click', function () {
          if (_this2.detectArg()) {
            _this2.page.insertBefore(_this2.slides[_this2.slides.length - 3], _this2.slides[0]);
          } else {
            _this2.page.insertBefore(_this2.slides[_this2.slides.length - 1], _this2.slides[0]);
          }
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$btn = _ref.btn,
      btn = _ref$btn === void 0 ? null : _ref$btn,
      _ref$page = _ref.page,
      ...
      _ref$prevModuleBtn = _ref.prevModuleBtn,
      prevModuleBtn = _ref$prevModuleBtn === void 0 ? null : _ref$prevModuleBtn,
...
/*#__PURE__*/
function () {
  function Video(btn, overlay, close) {
  ...
  _createClass(Video, [{
    ...
    value: function onPlayerStateChange(event) {
      var blockElem = this.activeBtn.closest('.module__video-item').nextElementSibling;
      var icon = this.activeBtn.firstElementChild.cloneNode(true);
      var lock = blockElem.querySelector('.closed');
